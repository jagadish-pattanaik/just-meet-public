...
import 'package:jagu_meet/screens/meeting/searchMeetings.dart';
  ...
  void _handleDeepLink(PendingDynamicLinkData data) async {
    ...
    if (deepLink != null) {
      ...
      Fluttertoast.showToast(
          ...
          textColor: Colors.white,
          fontSize: 16.0);
      if (deepLink.queryParameters['id'] != null || deepLink.queryParameters['id'] != '' || deepLink.queryParameters['id'] != 'open-app') {
              ...
              await FirebaseFirestore.instance.collection('Meetings').doc(
                ...
                if (host == _userEmail) {
                  ...
                  if (snapshot.data()['hasStarted'] == true) {
                    ...
                    _notStarted(linkroomid, linkroomtopic);
                  }
                }
              });
            } else {
                          ...
                          children: [
                            SizedBox(
                              ...
                              OutlineButton(
                                ...
                                color: Colors.transparent,
                                child: Icon(Icons.podcasts, color: Color(0xff0184dc),),
                              ),
                            ),
                            SizedBox(
                              height: 5,
            ...
            child: Column(
              ...
              children: <Widget>[
                ListTile(
                  ...
                  subtitle: Text('Theme, Diagnostic info', overflow: TextOverflow.ellipsis,),
                  contentPadding:
        ...
        child: StreamBuilder(
            ...
            builder: (context, snapshot) {
              if (!snapshot.hasData) {
                return Container(
                    child: QuietBox(
                      heading: "This is where you can find all ongoing conferences",
                      subtitle:
                                            ...
                                            CupertinoPageRoute(
                                                builder: (context) =>
                                                    LiveDetails(
                                                      ...
                                                      email: _userEmail,
                                                      PhotoUrl: _userPhotoUrl,
                                                      started: DateTime.parse(snapshot.data
                                                          .docs[position]["time"],).toLocal())));
                                      }
                                    } else {
                                      Fluttertoast.showToast(
      ...
      if (connectivityResult == ConnectivityResult.none) {
        ...
        await JitsiMeet.joinMeeting(
          ...
          listener: JitsiMeetingListener(onConferenceWillJoin: (message) {
            ...
            databaseService.addMyJoined(options.room, _userUid, options.subject, DateTime.now().subtract(Duration(seconds: 2)), _userName, _userEmail, _userPhotoUrl);
            setState(() {
              inMeeting = true;
            });
            Fluttertoast.showToast(
